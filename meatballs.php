...
<html lang="en">
    ...
    <body>
        ...
        <div id="container">
            ...
            <h2 class="title"> <?php echo $xml->recipe[0]->title ?> </h2>
            <div id="ingredients">

                <img src="<?php echo $xml->recipe[0]->image ?>" alt="Meatballs">

                <ul class="ingrTable">
                    <h4><?php echo $xml->recipe[0]->content->ingredients->title ?> </h4>
                    <?php foreach($xml->recipe[0]->content->ingredients->ingredient as $ingredient){
            ...
            <div id="method">
                <div id="summary">
                    <ul>
                        <li><?php echo $xml->recipe[0]->content->servings ?> </li>
                        <li><?php echo $xml->recipe[0]->content->preptime ?> </li>
                        <li><?php echo $xml->recipe[0]->content->cooktime ?> </li>
                        <li><?php echo $xml->recipe[0]->content->totaltime ?> </li>
                    </ul>
                </div>
                <h2 class="title"><?php echo $xml->recipe[0]->content->title ?> </h2>
                <p><?php echo $xml->recipe[0]->content->instructions->instruction ?>
                </p>
            </div>
            <hr>
